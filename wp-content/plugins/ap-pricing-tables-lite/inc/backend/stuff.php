...
?>
<div class="appts-use-title"><?php _e( 'More WordPress Resources', 'ap-pricing-tables-lite' ); ?></div>
<div class="appts-use-title-content">
    <div class='appts-how-to-use-wrapper'>

        <p> Themes Compatible with the Plugin :</p>

        <p>AP Pricing Tables Lite works best with every WordPress theme. It's even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.</p>
