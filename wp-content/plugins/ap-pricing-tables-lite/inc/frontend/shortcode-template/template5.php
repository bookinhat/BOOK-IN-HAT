...
<div class='appts-<?php echo esc_attr( $column_counts ); ?>-columns appts-table-wrapper clearfix appts-<?php echo esc_attr( $template ); ?> appts-table-wrapper-<?php echo esc_attr( $pricing_table[ 'id' ] ); ?>' data-table-id='<?php echo esc_attr( $pricing_table[ 'id' ] ); ?>'>
    ...
    .appts-table-wrapper-<?php echo $pricing_table[ 'id' ]; ?> .appts-table-item-wrapper .appts-ribbon-content-wrap{
    ...
    <?php if ( $template == 'template_05' ) { ?>
        .appts-table-wrapper-<?php echo $pricing_table[ 'id' ]; ?> .appts-table-item-wrapper .appts-table-item .appts-table-header-wrapper ,
        .appts-table-wrapper-<?php echo $pricing_table[ 'id' ]; ?> .appts-table-item-wrapper .appts-table-item .appts-table-header-wrapper .appts-img-wrapper {
        <?php if ( isset( $columns_border_enable ) && $columns_border_enable == '1' ): ?>
            border-radius: <?php echo $column_borders[ 'top' ]; ?>px <?php echo $column_borders[ 'right' ]; ?>px 0px 0px;
        <?php endif; ?>
        }
        .appts-table-wrapper-<?php echo $pricing_table[ 'id' ]; ?> .appts-content-all-wrap:hover,
        .appts-table-wrapper-<?php echo $pricing_table[ 'id' ]; ?> .appts-table-item-wrapper.appts-highlighted .appts-content-all-wrap{
        <?php if ( isset( $columns_border_enable ) && $columns_border_enable == '1' ): ?>
            border-radius: <?php echo $column_borders[ 'top' ]; ?>px <?php echo $column_borders[ 'right' ]; ?>px <?php echo $column_borders[ 'bottom' ]; ?>px <?php echo $column_borders[ 'left' ]; ?>px;
        <?php endif; ?>
        }
    ...
    <div class='appts-table-content-wrap'>
        ...
        if ( ! empty( $column_datas ) ) {
            foreach ( $column_datas as $key => $value ) {
                ...
                $body_settings = $value[ 'body' ];
                $footer_settings = $value[ 'footer' ];
                ...
                if ( $remove_header != '1' && isset( $new_feature_image ) && ($new_feature_image != '' && ($template == 'template_09' || $template == 'template_01' || $template == 'template_05' || $template == 'template_07' || $template == 'template_08' ) ) ) {
                                    ...
                                    <div class="appts-table-header-wrapper">
                                        ...
                                        ?>">
                                            <div class="appts-img-wrapper">
                                                <img src="<?php echo esc_url( $new_feature_image ); ?>" alt='Feature image' />
                                            </div>
                                            <div class="appts-title-wrap">
                                                ...
                                                <?php if ( isset( $title[ 'title' ][ 'content' ] ) && $title[ 'title' ][ 'content' ] != '' ) { ?>
                                                    <span class="appts-item-title" <?php echo esc_attr( $title_style ); ?> ><?php echo esc_html( $title[ 'title' ][ 'content' ] ); ?></span>
                                                <?php } ?>

                                                <?php if ( isset( $title[ 'subtitle' ][ 'content' ] ) && $title[ 'subtitle' ][ 'content' ] != '' ) { ?>
                                                    <span class="appts-item-sub_title" <?php echo esc_attr( $sub_title_style ); ?> ><?php echo esc_html( $title[ 'subtitle' ][ 'content' ] ); ?></span>
                                                <?php } ?>
                                            </div>

                                        </div>

                                        <div class="appts-pricing-info">
                                        ...
                                        <?php foreach ( $value[ 'body' ] as $key1 => $value1 ) { ?>
                                            <div class="appts-pricing-content">
                                                ...
                                                if ( $body_row[ 'type' ] == 'html' ) {
                                                    ...
                                                    <?php
                                                    if ( isset( $tooltip_options[ 'enable' ] ) && $tooltip_options[ 'enable' ] == '1' && $tooltip_contents[ 'content' ] != '' ) {
                                                        ?>

                                                        <?php
                                                        if ( isset( $tooltip_contents[ 'style' ][ 'font-family' ] ) && $tooltip_contents[ 'style' ][ 'font-family' ] != '' ) {
                                                            if ( ! in_array( $tooltip_contents[ 'style' ][ 'font-family' ], $google_fonts_used_array ) ) {
                                                                array_push( $google_fonts_used_array, preg_replace( '/\s/', '+', $tooltip_contents[ 'style' ][ 'font-family' ] ) );
                                                            }
                                                        }
                                                        ...
                                                        $dynamic_css = array();
                                                        if ( isset( $tooltip_contents[ 'style' ][ 'font-family' ] ) && $tooltip_contents[ 'style' ][ 'font-family' ] != '' ) {
                                                            $font_family = $tooltip_contents[ 'style' ][ 'font-family' ];
                                                            $dynamic_css[] = "font-family:$font_family";
                                                        }

                                                        if ( isset( $tooltip_contents[ 'style' ][ 'font-size' ] ) && $tooltip_contents[ 'style' ][ 'font-size' ] != '' ) {
                                                            $font_size = $tooltip_contents[ 'style' ][ 'font-size' ];
                                                            $dynamic_css[] = "font-size:{$font_size}px";
                                                        }

                                                        if ( isset( $tooltip_contents[ 'style' ][ 'font-style' ][ 'bold' ] ) && $tooltip_contents[ 'style' ][ 'font-style' ][ 'bold' ] != '' ) {
                                                            $dynamic_css[] = 'font-weight:bold';
                                                        }

                                                        if ( isset( $tooltip_contents[ 'style' ][ 'font-style' ][ 'italic' ] ) && $tooltip_contents[ 'style' ][ 'font-style' ][ 'italic' ] != '' ) {
                                                            $dynamic_css[] = 'font-style:italic';
                                                        }

                                                        if ( isset( $tooltip_contents[ 'style' ][ 'font-style' ][ 'strikethrough' ] ) && $tooltip_contents[ 'style' ][ 'font-style' ][ 'strikethrough' ] != '' ) {
                                                            $dynamic_css[] = 'text-decoration:line-through';
                                                        }

                                                        if ( isset( $tooltip_contents[ 'style' ][ 'font-style' ][ 'underline' ] ) && $tooltip_contents[ 'style' ][ 'font-style' ][ 'underline' ] != '' ) {
                                                            $dynamic_css[] = 'text-decoration:underline';
                                                        }

                                                        if ( isset( $tooltip_options[ 'width' ] ) && $tooltip_options[ 'width' ] != '' ) {
                                                            $dynamic_css[] = "width: {$tooltip_options[ 'width' ]}px";
                                                        }

                                                        if ( isset( $tooltip_options[ 'bg-color' ] ) && $tooltip_options[ 'bg-color' ] ) {
                                                            $dynamic_css[] = "background: {$tooltip_options[ 'bg-color' ]}";
                                                        }

                                                        if ( isset( $tooltip_options[ 'text-color' ] ) && $tooltip_options[ 'text-color' ] ) {
                                                            $dynamic_css[] = "color: {$tooltip_options[ 'text-color' ]}";
                                                        }
                                                        ...
                                                        ///////////////////////////////////////////////////////////////////////////////////////////
                                                        ?>
                                                        <div class='appts-pricing-tooltip' <?php echo esc_attr( $dynamic_css ); ?>><?php echo esc_attr( $tooltip_contents[ 'content' ] ); ?></div>
                                                        <?php
                                                    }
                                                }
                                                ...
                                                if ( $body_row[ 'type' ] == 'button' ) {
                                                    ...
                                                    <span class="appts-pricing-content-button" >
                                                        <a <?php echo esc_attr( $dynamic_css ); ?> href="<?php echo esc_url( $body_row[ 'button' ][ 'link' ] ); ?>"> <?php echo esc_attr( $body_row[ 'button' ][ 'text' ] ); ?></a>
                                                    </span>
                                                <?php }
                                                ?>
                                            </div>
                                            ...
                                            <div class='appts-pricing-footer-content'>
                                                ...
                                                if ( $footer_row[ 'type' ] == 'button' ) {
                                                    ...
                                                    <span class="appts-pricing-footer-content-button">
                                                        <a <?php echo esc_attr( $dynamic_css ); ?> href="<?php echo esc_url( $footer_row[ 'button' ][ 'link' ] ); ?>"> <?php echo esc_attr( $footer_row[ 'button' ][ 'text' ] ); ?></a>
                                                    </span>
                                                    <?php
                                                }
                                                ?>
