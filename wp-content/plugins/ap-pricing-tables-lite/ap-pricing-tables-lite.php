...
defined( 'APPTS_VERSION' ) or define( 'APPTS_VERSION', '1.0.6' );
...
if ( ! class_exists( 'APPTS_Class' ) ) {
    ...
    class APPTS_Class{
        ...
        function add_appts_menu(){
            ...
            add_submenu_page( 'ap-pricing-tables-lite', 'More WordPress Stuff', 'More WordPress Stuff', 'manage_options', 'ap-pricing-tables-lite' . '-stuff', array( $this, 'appts_stuff' ) );
        }
